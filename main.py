        ...
        for step, batch in enumerate(train_loader):
            ...
            if add_lora:
                ...
                if (step + 1) % 1000 == 0:
                    ...
                    heatmap_list_emb.append(delta_W_emb.cpu().numpy())
                    heatmap_list_fc1.append(delta_W_fc1.cpu().numpy())
                    heatmap_list_fc2.append(delta_W_fc2.cpu().numpy())
